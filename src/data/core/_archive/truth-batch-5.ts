...
export const CORE_BATCH_TRUTH_5: GameCard[] = [
  {
    id: "TRUTH-101",
    faction: "truth",
    name: "Three Hackers in a Basement",
    type: "DEFENSIVE",
    rarity: "rare",
    cost: 13,
    text: "Draw 1 card. Opponent discards 1 card.",
    flavorTruth: "Zero hygiene. One friend on the inside. Unlimited Mountain Dew.",
    flavorGov: "Zero hygiene. One friend on the inside. Unlimited Mountain Dew.",
  ...
  },
  {
    id: "TRUTH-102",
    faction: "truth",
    name: "FOIA Revenge Squad",
    type: "DEFENSIVE",
    rarity: "uncommon",
    cost: 10,
    text: "Gain 3 IP.",
    flavorTruth: "If it's stamped 'secret,' we've already leaked it to Reddit.",
    flavorGov: "If it's stamped 'secret,' we've already leaked it to Reddit.",
    target: { scope: "global", count: 0 },
  ...
  },
  {
    id: "TRUTH-103",
    faction: "truth",
    name: "Paranoid Press Co-Op",
    type: "DEFENSIVE",
    rarity: "uncommon",
    cost: 10,
    text: "Gain 1 IP and +3% Truth.",
    flavorTruth: "Ink by the people, for the people, about the lizard people.",
    flavorGov: "Ink by the people, for the people, about the lizard people.",
    target: { scope: "global", count: 0 },
  ...
  },
  {
    id: "TRUTH-104",
    faction: "truth",
    name: "Garage CSI: Paranormal Unit",
    type: "DEFENSIVE",
    rarity: "rare",
    cost: 12,
    text: "Gain 2 IP and draw 1.",
    flavorTruth: "DNA tests run next to Christmas decorations. Results questionable.",
    flavorGov: "DNA tests run next to Christmas decorations. Results questionable.",
    target: { scope: "global", count: 0 },
  ...
  },
  {
    id: "TRUTH-105",
    faction: "truth",
    name: "Conspiracy Geiger Counter",
    type: "DEFENSIVE",
    rarity: "uncommon",
    cost: 9,
    text: "+4% Truth.",
    flavorTruth: "Clicks faster near Area 51. Explodes near Congress.",
    flavorGov: "Clicks faster near Area 51. Explodes near Congress.",
    target: { scope: "global", count: 0 },
  ...
  },
  {
    id: "TRUTH-106",
    faction: "truth",
    name: "Industrial Tinfoil Distributor",
    type: "DEFENSIVE",
    rarity: "uncommon",
    cost: 9,
    text: "Gain 3 IP.",
    flavorTruth: "Military-grade hats for military-grade cover-ups.",
    flavorGov: "Military-grade hats for military-grade cover-ups.",
    target: { scope: "global", count: 0 },
    effects: { ipDelta: { self: 3 } }
  },
  {
