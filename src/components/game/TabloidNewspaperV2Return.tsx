  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 p-4 backdrop-blur-sm">
      <UICard className={cn(NEWSPAPER_CARD_CLASS, "max-h-[90vh] overflow-hidden flex flex-col")}>
        ...
        {/* Footer */}
        <footer className="border-t-4 border-newspaper-border bg-newspaper-header/90 px-6 py-4 flex-shrink-0">
          <div className="flex flex-col items-center gap-3 sm:flex-row sm:justify-between">
            ...
            <Button
              variant="secondary"
              onClick={onClose}
              className="font-black uppercase tracking-wide hover:scale-105 transition-transform"
            >
