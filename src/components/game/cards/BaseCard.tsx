...
export const BaseCard = ({
  ...
  const autoGeneratedText = getAutoGeneratedCardText(card)?.trim();
  const providedText = card.text?.trim();
  const showCardText = Boolean(
    providedText &&
      providedText !== effectText.trim() &&
      (!autoGeneratedText || providedText !== autoGeneratedText),
  );
