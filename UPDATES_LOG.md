...
## 2025-11-27 – Archive 50-match scrimmages and promote stronger weights
- Ran the simulator in five 10-game slices to capture a 50-match NDJSON corpus for offline learning experiments.
- Promoted the highest-scoring tuning from a follow-up optimization loop, refreshing `aiWeights.json` with the winning profile.
