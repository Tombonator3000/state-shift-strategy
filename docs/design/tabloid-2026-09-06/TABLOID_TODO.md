...
Status: **implementert og merget i PR #806–808; restkontroller er oppført nedenfor**.
...
Merget fra `c38743e7` til `cb187773`: felles målvelger, pressure-paritet, ny radio,
...
| Oppgaver | Status |
| --- | --- |
| T01–T02 | Implementert. Motor-, hook- og komponenttester består; publisert PC-målvalg og 360×640 mobilmålvalg med kostnad er bekreftet i nettleseren. |
| T03–T04 | Implementert. Feil Pages-adresse rettet; 12 spor validert med ffprobe. Theme-1 er fortsatt tom og hoppes over. Alle 12 filer er også fullt dekodet med ffmpeg; nettleseren starter, pauser og bytter spor. Hørbar avspilling på fysisk telefon gjenstår. |
...
| T07–T08 | Tabloidstil og responsiv forside implementert; 390×844 avis og 1280×800 helt PC-kart er kontrollert i publisert bygg. Mobiltekst og arkivplass er rettet etter kontrollen. |
| T09–T11 | Implementert: faktiske utfall, kilder, arkiv og én kø. Kombotester og kvitteringstester består. |
| T12 | Hovedkøen er implementert; capture vises i kortkvittering. Enkelte eldre paranormale kosmetiske lag er beholdt. Kort→AI→avis→ny tur fungerer i nettleseren. Full kontroll av alle eldre effektkombinasjoner gjenstår. |
